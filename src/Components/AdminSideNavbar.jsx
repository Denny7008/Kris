...
//           <Link to="/admin/login/AdminDashboard/JobPanels" className="ml-2">Dashboard</Link>
//         </a>
...
//           <Link to="/admin/login/AdminDashboard/EmployeeManagement" className="ml-2">Employee Management</Link>
//         </a>
//         <a href="#" className="flex items-center p-2 mb-2 hover:bg-blue-800 rounded-lg">
//           <span className="material-icons">book</span>
//           <Link to="/admin/login/AdminDashboard/LeaveManagement" className="ml-2">Leave Management</Link>
//         </a>
//         <a href="#" className="flex items-center p-2 mb-2 hover:bg-blue-800 rounded-lg">
//           <span className="material-icons">assessment</span>
//           <Link Link to="/admin/login/AdminDashboard/PerformanceManagement" className="ml-2">Performance Management</Link>
//         </a>
