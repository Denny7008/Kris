...
//   // State to store guarantor details
//   const [guarantorDetails, setGuarantorDetails] = useState([
//     {
//       name: "Mr. Johnnie Walker Deep",
//       position: "Head of Design Team, Microsoft Inc.",
//       contact: "090 500 500 6000",
//     },
//     {
//       name: "Miss Walkie Talkie",
//       position: "Human Resources Manager, Apple Inc.",
//       contact: "090 400 400 4848",
//     },
//   ]);

//   // Function to handle updating guarantor details
//   const handleUpdateGuarantorDetails = (newDetails) => {
//     setGuarantorDetails((prevDetails) => [...prevDetails, newDetails]);
...
//       {showUpdateForm ? (
//         <UpdateGuarantorForm onSubmit={handleUpdateGuarantorDetails} />
//       ) : (
//         <div className="max-w-2xl bg-white rounded-lg p-6 space-y-6 shadow-lg">
//           {/* Guarantor Records Section */}
//           <div>
...
//                   <p className="text-sm text-gray-600">{detail.position}</p>
