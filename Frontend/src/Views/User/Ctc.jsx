...
//       const userId = localStorage.getItem("id"); // Retrieve user ID stored after login
//       console.log(token);
//       console.log(userId);
...
const Ctc = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log("Contact token",token) // Retrieve user ID stored after login
      console.log("Contact userId", userId) // Retrieve user ID stored after login
