...
const JobPanels = () => {
  ...
  useEffect(() => {
    // fetch ats Score
    axios
      .post("http://localhost:5000/calculate-ats")
      .then((response) => {
  ...
  const jobImages = {
    ...
    "Data Analyst":
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Data-icon.svg/512px-Data-icon.svg.png",
    "Project Manager":
      "https://upload.wikimedia.org/wikipedia/commons/3/3a/Project-management-icon.png",
    "UI/UX Designer":
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Adobe_XD_CC_icon.svg/512px-Adobe_XD_CC_icon.svg.png",
    "React Developer":
      "https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg",
    "Marketing Specialist":
      "https://upload.wikimedia.org/wikipedia/commons/e/e5/Digital_marketing_icon.png",
    "Sales Representative":
      "https://upload.wikimedia.org/wikipedia/commons/9/91/Sales-icon.png",
    "Cybersecurity Analyst":
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Cybersecurity_icon.png/512px-Cybersecurity_icon.png",
    "AI Engineer":
      "https://upload.wikimedia.org/wikipedia/commons/7/7c/Keras_logo.svg",
    "Product Manager":
      "https://upload.wikimedia.org/wikipedia/commons/f/f6/Product_management_icon.png",
    "Devops Enginner":
      "https://www.guvi.in/blog/wp-content/uploads/2023/10/devops-logo-1200x675.webp",
    Tester:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIhpW4XrteLxojOCPgZFmbaxLm1kXxnlhQRRcjHkYOBYEzAl8PoYTnk2b7VB4lmIF3620&usqp=CAU",
  };
                    ...
                    employees.map((employee, index) => (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <img
                            src={
                              employee.profilePic || "/path-to-placeholder.png"
                            }
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            onClick={() => handleDownloadPDF(employee._id)}
