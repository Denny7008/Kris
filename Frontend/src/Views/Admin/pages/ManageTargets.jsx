...
//                 <td className="p-4"> {target.user ? `${target.user.firstName} ${target.user.lastName}` : "Unknown"}</td>
...
//               <tr key={target._id} className="border-b hover:bg-gray-100">
//                 <td className="p-4">
//                   {target.user ? `${target.user.firstName} ${target.user.lastName}` : "Unknown"}
//                 </td>
//                 <td className="p-4">{target.title}</td>
//                 <td className="p-4">{target.kpiWeight}</td>
//                 <td className="p-4">
          ...
          <tbody>
            {targets.map((target, index) => (
              <tr key={target._id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-4">{target.status || "Pending"}</td>
                <td className="p-4">
                  <div className="relative">
                    <button
                      onClick={() => handleActionClick(index)}
